...
export const features: Feature[] = [
  {
    ...
    description: 'bmc.features.angular',
  ...
  },
  {
    ...
    description: 'bmc.features.angular-material',
  ...
  },
  {
    ...
    description: 'bmc.features.angular-cli',
  ...
  },
  {
    ...
    description: 'bmc.features.bootstrap',
  ...
  },
  {
    ...
    description: 'bmc.features.typescript',
  ...
  },
  {
    ...
    description: 'bmc.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'bmc.features.fontawesome',
  ...
  },
  {
    ...
    description: 'bmc.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'bmc.features.themes.title',
    description: 'bmc.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'bmc.features.lazyloading.title',
    description: 'bmc.features.lazyloading.description',
    documentation:
